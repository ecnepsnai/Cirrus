...
/**
 ...
 @param dismissed Called when the view has been dismissed.
 */
- (void) showEmailComposeSheetForAppInViewController:(UIViewController * _Nonnull)viewController withComments:(NSString * _Nullable)comments dismissed:(void(^ _Nullable)(void))dismissed;
