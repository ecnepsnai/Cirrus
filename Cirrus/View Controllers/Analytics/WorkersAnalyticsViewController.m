#import "WorkersAnalyticsViewController.h"
#import "CFAnalyticView.h"

@interface WorkersAnalyticsViewController ()
...
@implementation WorkersAnalyticsViewController
...
typedef NS_ENUM(NSUInteger, AnalyticsViewType) {
    AnalyticsViewTypeSubrequests   = 0,
    AnalyticsViewTypeBandwidth     = 1,
    AnalyticsViewTypeStatusCodes   = 2,
    AnalyticsViewTypeTotalRequests = 3,
};
